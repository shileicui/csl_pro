...
//异步消息 tms.order.delivery
/index.php?r=timing/order-delivery
...
index.php?r=timing/ai-review-order
...
test
REDIS_AI_CLUSTER_NODES=172.19.166.212:6380
REDIS_AI_CLUSTER_PASSWORD=@test@redis@
...
alter table
   tms_signing_conf
add
 `back_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '返回模式 1 固定日期 2 时间间隔';
