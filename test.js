...
(function () {
	...
	function abroadVideoHelper(){
		this.isRun = function(){
			var urls=["youtube.com", "facebook.com","www.tiktok.com"];
			for(var i=0; i<urls.length;i++){
				if(window.location.host.indexOf(urls[i])!=-1){
					return true;
				}
		...
		this.start = function(){
			...
			setInterval(function(){
				...
				if(host.indexOf("tiktok.com")!=-1){
					if(href.indexOf("www.tiktok.com/@")!=-1){
						if($("#"+eleId).length != 0){
							return;
						}
						var iconVideo = "data:image/png;base64,";
						var html='<div id="'+eleId+'" style="width:25px;padding:10px 0px;text-align:center;background-color:#E5212E;position:fixed;bottom:100px;left:0px;color:#FFF;font-size:0px;z-index:9999999999999;cursor:pointer;margin:0px auto;text-align:center;">'+
							'<img src="'+iconVideo+'" style="width:20px;">'+
							'</div>';
						$("body").append(html);
						$("body").on("click", "#"+eleId, function(){
							commonFunctionObject.GMopenInTab("https://tikmate.app?="+window.location.href);
						});
					}else{
						$("#"+eleId).remove();
					}
	...
	GM_registerMenuCommand("低侵入！优惠券查询",function(){
		commonFunctionObject.GMopenInTab("https://greasyfork.org/zh-CN/scripts/469417");
	});
